...
import { loadProjects, getProjectsByCategories, serviceToCategoryMap, Project } from "@/lib/projects-data";
...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    if (service) {
      loadProjects().then(() => {
        const projects = getProjectsByCategories(service.categories);
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              {/* Project Gallery - Only show if we have projects */}
              {!loading && serviceProjects.length > 0 && (
                <>
                  <h3 className="text-xl font-bold mb-4">Our {service.title} Projects</h3>
                  ...
                  <Button asChild>
                    <Link to={`/projects?category=${primaryCategory}`}>
                      View All {primaryCategory} Projects
